...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SZentraleQuery :  IEquatable<SZentraleQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SZentraleQuery" /> class.
        /// </summary>
        ...
        public SZentraleQuery(long offset = default(long), long limit = default(long), long total = default(long), List<SZentrale> result = default(List<SZentrale>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
        ...
        public List<SZentrale> Result { get; set; }
        ...
        {
            return this.Equals(input as SZentraleQuery);
        }

        /// <summary>
        /// Returns true if SZentraleQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of SZentraleQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SZentraleQuery input)
        {
            if (input == null)
                return false;
